...
export function generateLineageData(
  fileName: string,
  filePath: string,
  store: string,
  storeSource: string,
...
export function LineageDetailPanelContent({
            ...
            <div className="relative px-2">
              ...
              {filteredActivities.map((act) => {
                ...
                return (
                  ...
                  >
                    {/* Timeline dot */}
                    <div className="absolute left-[5px] top-3 w-3.5 h-3.5 rounded-full border-2"
                      style={{
...
// ── Slim Export: just the button + panel, no mini-graph ──────────────────────

export function LineageButtonOnly({
